...
export const site = {
  name: "凌云·LinYun",
  desc: "桂枝日已绿，拂雪凌云端",
  url: "https://blog.linyunlink.top",
  avatar: "https://image.linyunlink.top/logo/avatar.jpg",
  email: "linyun@linyunlink.top",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">评论区留言（推荐）/发送申请邮件至：<code class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem]">{site.email}</code></p>
