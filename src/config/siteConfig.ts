...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://blog.linyunlink.top",

	// 站点描述
	description:
		"我是一名开发者、高中学生，专注于各类技术的研究与应用。 同样也喜欢数学、物理、化学和生物等各种理科鸭~在我的博客 blog.linyunlink.top 上，我分享技术文章、项目经验和学习心得， 希望能够与更多开发者交流学习，共同成长。",
	...
	favicon: [
		{
			// 图标文件路径
			src: "https://image.linyunlink.top/logo/favicon.ico",
			// 可选，指定主题 'light' | 'dark'
			// theme: "light",
			// 可选，图标大小
			// sizes: "32x32",
